...
export const sampleWithPartialData: IEmployeeDetails = {
  ...
  joiningDate: dayjs('2022-09-20T18:24'),
  createdOn: dayjs('2022-09-21T13:01'),
...
export const sampleWithFullData: IEmployeeDetails = {
  ...
  nationality: 'Sleek expedite',
  description: 'teal withdrawal',
  department: 'hard payment Savings',
  joiningDate: dayjs('2022-09-21T06:31'),
  createdBy: 'Assistant',
  createdOn: dayjs('2022-09-21T02:39'),
  freefield1: 'enhance',
